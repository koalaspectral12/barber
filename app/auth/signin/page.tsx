...
// Componente interno que usa useSearchParams — deve ficar dentro do <Suspense>
function SignInForm() {
...
// Página principal — envolve o form com <Suspense> para satisfazer o Next.js
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gray-950 px-4">
      <div className="w-full max-w-md">
        ...
        {/* Formulário envolvido em Suspense — obrigatório para useSearchParams */}
